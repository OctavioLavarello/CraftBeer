          ...
          <Form className={styles.formPut} onSubmit={handlerOnSubmit}>
            ...
            <Form.Group>
              ...
              <div className={styles.divInputP}>
                ...
                />
                {errors.lastName && (
                  <p className={styles.validationMessage}>{errors.lastName}</p>
                )}
              </div>
            </Form.Group>
                </Col>
            ...
            <Form.Group>
              ...
              <div className={styles.divInputP}>
                ...
                {errors.country && (
                  <p className={styles.validationMessage}>{errors.country}</p>
                )}
              </div>
            </Form.Group>
                </Col>
            ...
            <Form.Group>
              ...
              <div className={styles.divInputP}>
                ...
                />
                {errors.company && (
                  <p className={styles.validationMessage}>{errors.company}</p>
                )}
              </div>
            </Form.Group>
                </Col>
            ...
            <Form.Group>
              ...
              <div className={styles.divInputP}>
                ...
                />
                {errors.address && (
                  <p className={styles.validationMessage}>{errors.address}</p>
                )}
              </div>
            </Form.Group>
                </Col>
